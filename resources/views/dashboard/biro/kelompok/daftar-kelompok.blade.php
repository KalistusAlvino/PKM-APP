...
@section('content')
    ...
    <div class="row mb-2 mx-1">
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <form id="filterForm" method="GET" action="{{ route('biro.daftar-kelompok-page') }}">
                <div class="input-group mb-3">
                    ...
                    <select class="form-select" name="filter_judul" aria-label="Default select example" id="filterSelect">
                        <option value="" {{ request('filter_judul') === null || request('filter_judul') === '' ? 'selected' : '' }}>Filter berdasarkan</option>
        ...
        <div class="table-responsive">
            <table class="table table-striped bg-third-color my-3 text-center">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="text-center primary-color fw-bold fst-italic">Belum ada atau tidak
                                ada
                                kelompok</td>
                        </tr>
                    @endforelse
