...
@section('title', 'Biro - Manajemen Berita')
@section('content')
            ...
            <div class="col-12 px-md-4 content-wrapper">
                ...
                <div
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <a href="{{ route('biro.tambah-berita') }}" type="button" class="btn btn-sm btn-primary">
                                ...
                                <tbody>
                                    @forelse ($berita as $idx=> $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('biro.update-berita', $item->id) }}"
                                                    class="btn btn-sm btn-outline-primary">
                                                    <i class="fa-solid fa-pen-to-square"></i>
                                                </a>
                                                <button class="btn btn-sm btn-outline-danger" onclick="confirmDelete('{{route('biro.delete-berita',$item->id)}}')">
                                                    <i class="fa-solid fa-trash"></i>
                                                </button>
                                                <a href="{{ route('detail-berita', $item->id) }}" target="_blank"
