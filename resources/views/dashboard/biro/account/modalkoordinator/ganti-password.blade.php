<!-- Modal -->
<div class="modal fade" id="ganti-password-koordinator" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<script>
    const passwordModal = document.getElementById('ganti-password-koordinator');
