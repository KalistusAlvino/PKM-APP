@extends('assets.main')
@section('title', 'PKM UKDW | Berita PKM')
@section('content')
    <div class="container-fluid py-4">
        <div class="container">
            ...
            <nav aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('halamanHome')}}" class="text-decoration-none text-secondary">Beranda</a></li>
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <h1 class="fw-bold primary-color">{{$berita->title}}</h1>
                    <p class="text-secondary mb-0">
                        <i class="fa-regular fa-calendar me-1"></i> {{$berita->updated_at->diffForHumans()}}
                    </p>
                </div>
            </div>
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <img src="{{ $berita->gambar ? asset('storage/' . $berita->gambar) : 'https://place-hold.it/700x600' }}"
